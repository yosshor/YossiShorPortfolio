          ...
          <div className="glass-panel rounded-2xl p-8 md:p-12 relative z-10">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-slate-100 dark:bg-dark-900/50 rounded-xl p-4 border border-slate-200 dark:border-white/5">
                  <img 
                  ...
                  />
                  <img 
                    src="https://github-readme-stats.vercel.app/api?username=yosshor&show_icons=true&theme=default&hide_border=true&bg_color=f1f5f9&title_color=0284c7&icon_color=a855f7&text_color=334155"
                    alt="GitHub Stats"
                ...
                <div className="bg-slate-100 dark:bg-dark-900/50 rounded-xl p-4 border border-slate-200 dark:border-white/5">
                  ...
                  />
                  <img 
                    src="https://github-readme-stats.vercel.app/api/top-langs/?username=yosshor&layout=compact&theme=default&hide_border=true&bg_color=f1f5f9&title_color=0284c7&text_color=334155"
                    alt="Top Languages"
                    className="w-full dark:hidden block"
                  />
                </div>
              </div>
              <div className="mt-4 bg-slate-100 dark:bg-dark-900/50 rounded-xl p-4 border border-slate-200 dark:border-white/5">
                <img 
                ...
                />
                <img 
                  src="https://github-readme-streak-stats.herokuapp.com/?user=yosshor&theme=default&hide_border=true&background=f1f5f9&ring=0284c7&fire=a855f7&currStreakLabel=334155"
                  alt="GitHub Streak"
                  className="w-full dark:hidden block"
                />
              </div>
